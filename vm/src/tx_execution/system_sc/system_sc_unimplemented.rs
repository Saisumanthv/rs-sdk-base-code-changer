...
pub fn register_meta_dct(tx_input: TxInput, tx_cache: TxCache) -> (TxResult, BlockchainUpdate) {
    unimplemented!()
}
...
pub fn dct_burn(tx_input: TxInput, tx_cache: TxCache) -> (TxResult, BlockchainUpdate) {
    unimplemented!()
}
